...
export default function ItemDetailPage() {
  ...
  return (
    <div className="page">
      <main className="mx-auto max-w-[760px] px-5 pb-[150px] pt-4 lg:pb-16">
        ...
        <section className="mt-5 hidden rounded-[30px] border border-white/80 bg-white/88 p-4 shadow-[0_12px_32px_rgba(15,23,42,0.045)] backdrop-blur-xl lg:block">
          <button
            ...
            className="flex h-[60px] w-full items-center justify-center gap-2 rounded-[18px] bg-[#007C6C] text-[18px] font-black text-white shadow-[0_16px_36px_rgba(0,124,108,0.26)] transition active:scale-[0.98]"
          >
            {isOwner ? (
      ...
      <div className="fixed inset-x-0 bottom-0 z-[9999] bg-[#007C6C] px-4 pb-[calc(env(safe-area-inset-bottom,0px)+16px)] pt-3 shadow-[0_-12px_36px_rgba(15,23,42,0.20)] lg:hidden">
        <div className="mx-auto max-w-[760px]">
          <button
            type="button"
            onClick={isOwner ? goToEdit : proposeExchange}
            className="flex h-[60px] w-full items-center justify-center gap-2 rounded-[18px] bg-[#007C6C] text-[18px] font-black text-white ring-1 ring-white/35 transition active:scale-[0.98]"
          >
            {isOwner ? (
              <PenLine size={20} strokeWidth={2.5} />
            ) : (
