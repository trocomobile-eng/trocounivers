    ...
    <section className="mx-auto mt-9 max-w-7xl px-5">
      <div className="overflow-hidden rounded-[38px] border border-white/80 bg-white/72 shadow-[0_20px_70px_rgba(15,23,42,0.055)] backdrop-blur-xl">
        <div className="grid items-center gap-8 p-6 md:p-9 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="relative overflow-hidden rounded-[34px] bg-white/80 p-5 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.8)]">
            ...
            <div className="relative grid grid-cols-3 gap-2 sm:gap-4">
              {objects.map((item, index) => (
                <div
                  key={item.title}
                  className={[
                    "min-w-0 overflow-hidden rounded-[20px] bg-white/78 p-2 shadow-[0_14px_34px_rgba(15,23,42,0.055)] sm:rounded-[28px] sm:p-3",
                    index === 1 ? "mt-5 sm:mt-8" : "",
                    index === 2 ? "mt-2 sm:mt-3" : "",
                  ].join(" ")}
                >
                  <div className="aspect-[3/4] overflow-hidden rounded-[16px] bg-slate-100 sm:rounded-[24px]">
                    <img
                      src={item.image}
                      alt={item.title}
                  ...
                  <p className="mt-3 text-[11px] font-black leading-tight text-[#081225] sm:mt-4 sm:text-[14px]">{item.title}</p>
                  <p className="mt-1 text-[10px] font-semibold leading-tight text-[#64748B] sm:text-[12px]">{item.meta}</p>
                </div>
              ))}
            </div>
          </div>
...
export default function LandingPage() {
  ...
  return (
    <main className="troco-landing-page min-h-screen overflow-x-hidden text-[#081225]">
      <LanguageSwitcher />
