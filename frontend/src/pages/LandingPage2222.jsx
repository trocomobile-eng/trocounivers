...
function LanguageSwitcher() {
  ...
  return (
    <div className="absolute right-5 top-5 z-40 flex items-center rounded-full border border-[#E4ECE8] bg-white/82 p-1 shadow-[0_10px_30px_rgba(15,23,42,0.055)] backdrop-blur-xl lg:right-8 lg:top-8">
      <button
        type="button"
...
export default function LandingPage() {
  ...
  return (
    <main className="troco-landing-page relative min-h-screen overflow-x-hidden bg-[var(--troco-bg)] text-[#081225]">
      ...
      <section className="relative px-5 pb-19 pt-20 md:pb-20 md:pt-14">
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative z-20 mx-auto w-full max-w-[410px] text-center lg:mx-0 lg:max-w-[360px] lg:text-left">
            <div className="mb-5 flex justify-center lg:mb-7 lg:justify-start">
              <div className="origin-center scale-[1.18] lg:origin-left lg:scale-[1.42]">
                <TrocoLogo size="l" />
              </div>
            </div>
            ...
            <div className="mx-auto mt-7 flex w-full max-w-[370px] flex-col gap-3 lg:mx-0 lg:max-w-none lg:flex-row">
              <button
                ...
                className="inline-flex min-h-[60px] w-full items-center justify-center gap-2 rounded-[24px] bg-gradient-to-r from-[#18BFAF] to-[#2ECC8A] px-7 py-4 text-[17px] font-black text-white shadow-[0_16px_38px_rgba(24,191,175,0.30)] ring-1 ring-white/50 transition active:scale-[0.98] lg:w-auto"
              >
                {t("landing.prototype")}
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex min-h-[60px] w-full items-center justify-center rounded-[24px] border border-[#E4ECE8] bg-white/88 px-6 py-4 text-center text-[16px] font-black text-[#081225] shadow-[0_10px_28px_rgba(15,23,42,0.045)] backdrop-blur-xl transition active:scale-[0.98] lg:w-auto"
              >
                {t("landing.help")}
              </a>
            </div>
      ...
      <section className="relative mx-auto grid max-w-7xl gap-4 px-5 md:grid-cols-3 md:gap-5">
        <ValueCard
          icon={Sparkles}
