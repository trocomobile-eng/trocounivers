...
function PageShell({ children, className = "" }) {
  return (
    <main
      className={[
        "min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(45,212,191,0.04),transparent_30%),radial-gradient(circle_at_top_right,rgba(34,211,238,0.03),transparent_35%),linear-gradient(to_bottom,#fcfffe_0%,#ffffff_100%)] pb-32 text-[#081225] lg:troco-desktop-page lg:pb-14",
        className,
      ].join(" ")}
    >
      {children}
