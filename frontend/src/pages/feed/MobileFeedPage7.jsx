      ...
      <div className="relative p-2.5">
        ...
        {getOwnerProfilePath(item) ? (
          ...
          >
            ...
            <p className="truncate text-[10.5px] font-semibold text-[#66758A]">
              par {ownerName}
            </p>
          </button>
        ) : (
    ...
    <MobileLayout>
      ...
      <section className="mt-2 space-y-3">
        <div className="flex items-center gap-2">
          <div className="flex h-[56px] flex-1 items-center gap-4 rounded-[18px] border border-[#E7DED2] bg-white px-4 shadow-[0_10px_26px_rgba(15,23,42,0.055)]">
            <Search size={23} strokeWidth={2.1} className="shrink-0 text-[#102033]" />

            <input
              value={search}
              onChange={(event) => setSearch(event.target.value)}
              placeholder="Rechercher un objet, une catégorie..."
              className="min-w-0 flex-1 bg-transparent text-[12.5px] font-semibold text-[#102033] outline-none placeholder:text-[#94A0AF]"
            />
          </div>
          ...
          <button
            ...
            className="relative flex h-[56px] w-[56px] shrink-0 items-center justify-center rounded-[18px] border border-[#E7DED2] bg-white shadow-[0_10px_26px_rgba(15,23,42,0.055)]"
          >
            <SlidersHorizontal size={21} strokeWidth={2.1} className="text-[#102033]" />
      ...
      <section className="mt-6">
        <div className="mb-4 flex items-center justify-between gap-3">
          <h2 className="text-[25px] font-black tracking-[-0.055em] text-[#102033]">
            Autour de toi
          </h2>
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              className="inline-flex h-10 items-center gap-1.5 rounded-full border border-[#E7DED2] bg-white px-3.5 text-[13px] font-black text-[#16A085]"
            >
              Paris
            </button>
            ...
            <button
              type="button"
              onClick={() => setShowFilters(true)}
              className="inline-flex h-10 items-center gap-1.5 rounded-full border border-[#E7DED2] bg-white px-3.5 text-[13px] font-black text-[#102033]"
            >
              Filtres
            </button>
          </div>
